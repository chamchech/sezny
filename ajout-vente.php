...
<body>
    <div class="main-page-wrapper">
        ...
        <div class="inscription-us-page section-spacing-inscription">
            <div class="container">
                <form enctype="multipart/form-data" method="post" action="pdf/abonnement-mepery.php"  class="theme-form-one form-validation">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-12 form-group">
                                    ...
                                    <select name="drop1" required="" style="width: 100%;
    background: #f7f7f7;
    ...
    padding: 10px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-12 form-group">
                                <label>IBAN</label>
                                <input type="text" placeholder="Votre IBAN" id="iban" name="iban" class="call-back-form-one" required>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <center><a href="index.php"><button style="background-color:#801010" class="theme-button-one">Annuler</button></a></center>
                </div>
            </div>
        </div>
    </div>
...
<footer class="theme-footer-one">
    <div class="container">
        <div class="top-footer">
            <div class="logo">
                <a href="https://www.mepery.fr/"><img src="images/logo/logofooter.png" alt="logo" class="logofooter"></a>
            </div>
        </div> <!-- /.top-footer -->
    </div> <!-- /.container -->

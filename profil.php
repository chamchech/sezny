            ...
            <main role="main">
                ...
                <section class="jumbotron text-center" style="padding:20px">
                    <div class="container">
                        ...
                        <a href="accueil.php"><svg class="bi bi-arrow-bar-left" width="1em" height="1em"
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-6">
                                <div class="card mb-4 box-shadow" style="width:100%">
                                    <div class="card-body ">
                                        <p><b>Nom : </b><?php echo $result[0]['firstname'].' '.$result[0]['lastname'];?>
                                        </p>
                                        <p><b>Ville : </b> <?php echo $result[0]['postcode'].' '.$result[0]['city'];?>
                                        </p>
                                        ...
                                        <center>
                                            <form method="POST"><input href="#modal1" class="btn btn-primary js-modal"
                                                    type="submit" name="download" value="Modifier son mot de passe">
                                            </form>
                                        </center>
                                        <!-- Début pop up -->
                                        <aside id="modal1" class="modal" aria-hidden="true" role="dialog"
                                            style="display: none;">
                                            <div class="modal-wrapper js-modal-stop">
                                                <button class="js-modal-close"
                                                    style="float:right;background:#999999;"><i class="fas fa-times"
                                                        style="width:50px;"></i></button><br><br>
                                                <div class="row justify-content-center">
                                                    <div class="col-md-6">

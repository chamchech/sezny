    ...
    <div id="bloc-principal">
        ...
        <main role="main">
            ...
            <section class="jumbotron text-center" style="padding:20px">
                <div class="container">
                    <h1 class="jumbotron-heading">Mon profil</h1>
                    <a href="accueil.php">
                        <svg class="bi bi-arrow-bar-left" width="1em" height="1em"
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6">
                            <div class="card mb-4 box-shadow" style="width:100%">
                                <div class="card-body ">
                                    <p><b>Nom
                                            : </b><?php echo $result[0]['firstname'] . ' ' . $result[0]['lastname']; ?>
                                    </p>

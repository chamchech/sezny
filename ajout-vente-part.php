...
<body>
<div class="main-page-wrapper justify-content-center">
    <!-- -------------------------------------------------------------------------- titre -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12">
                        <h2>Vente Part</h2>
                        <p class="lead">
                            <a class="btn btn-danger btn-lg" href="index.php" role="button">Retour</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="jumbotron  text-center" style="margin-bottom: -100px">
        <h1 class="display-4">Ajout vente Part</h1>
        <p class="lead">Commercial(e) : <?php echo $result[0]['firstname'] . ' ' . $result[0]['lastname']; ?></p>
        <!--<p>Quoi qu'il arrive, essayez toujours de laisser un bon souvenir de votre passage.</p>-->
        <p class="lead">
            <a class="btn btn-outline-dark btnlieu" href="index.php" role="button">Retour</a>
        </p>
        <hr class="my-4">
    </div>
    ...
    <div class="container">
        <form enctype="multipart/form-data" method="post" action="pdf/bc-particulier.php"
            ...
            <center><h3 class="liltitle">Vente Produit et Prestation</h3></center>
            <div class="row formInscription">
                <div class="col">
                    <div class="formProduit form-group">
                        ...
                        <div class="form-check form-switch">
                            <div>
                                <input class="form-check-input" type="checkbox" id="packautre"
                                       name="autredesignation"
                                       onclick="ChangePack()">
            ...
            <div class="row formInscription">
                <div class="col">
                    <div class="form-info">
                        <input type="radio" class="btn-check call-back-form-one" value="Domicile"
                               name="lieucommande" id="btn-check-outlined" autocomplete="off" required>
                ...
                <div class="col-lg-6 col-12 form-group">
                    <label>Ville</label>
                    <input type="text" name="lieucommande"
...
padding: 10px;">
            ...
            -->
                ...
                <div class="row formInscription">
                    ...
                    <div class="col form-group">
                        ...
                        <input type="text" name="nomcontact" class="call-back-form-one"
                               required>
                    </div>
                </div>
                <div class="row formInscription">
                    <div class="col form-group">
                        ...
                        <input type="text" name="tel" class="call-back-form-one"
                               pattern="[0-9]{2}[ \.\-]?[0-9]{2}[ \.\-]?[0-9]{2}[ \.\-]?[0-9]{2}[ \.\-]?[0-9]{2}[ \.\-]?"
                               required>
                    </div>
                    <div class="col form-group">
                        <label>Adresse Email</label>
                        <input type="text" id="mailverif" name="email"
                    ...
                    <div class="row formInscription">
                        <div class="col form-group">
                            <label>Adresse</label>
                            <input type="text" class="call-back-form-one"
                                   name="adresse"
                                   required>
                        </div>
                        <div class="col form-group">
                            <label>Code Postal</label>
                            <input type="text" name="cp" class="call-back-form-one"
                                   pattern="[0-9]{2,3}[ \.\-]?[0-9]{3}" required>
                        </div>
                        <div class="col form-group">
                            <label>Ville</label>
                            <input type="text" class="call-back-form-one" name="ville"
                                   required>
                        </div>
                    </div>
                    ...
                    <div class="row commandeInfo">
                        <div class="col">
                            <div class="form-info">
                                <input type="radio" class="btn-check call-back-form-one" value="Marié"
                                       name="situation" id="btn-check-outlined-situation" onclick="Change()"
                                       autocomplete="off" required>
                                <label class="btn btn-outline-primary btnlieu"
                                       for="btn-check-outlined-situation">Marié</label>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-info">
                                <input type="radio" class="btn-check call-back-form-one"
                                       id="btn-check-outlined-situation2"
                                       name="situation"
                                       value="Célibataire">
                                <label class="btn btn-outline-primary btnlieu"
                        ...
                        <div class="col">
                            <div class="form-info">
                                <input type="radio" class="btn-check call-back-form-one"
                                       id="btn-check-outlined-situation3"
                                       name="situation"
                                       value="Pacsé">
                                <label class="btn btn-outline-primary btnlieu"
                                       for="btn-check-outlined-situation3">Pacsé</label>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-info">
                                <input type="radio" class="btn-check call-back-form-one"
                                       id="btn-check-outlined-situation4"
                                       name="situation"
                                       value="Veuf">
                                <label class="btn btn-outline-primary btnlieu"
                                       for="btn-check-outlined-situation4">Veuf</label>
                            </div>
                        </div>
                    </div>
                    <div id="dynamicForm">
                        ...
                        <div class="row formInscription">
                            <div class="col form-group">
                                <label>Prénom</label>
                                <input type="text" name="prenomtitulaire"
                                       class="call-back-form-one">
                            </div>
                            <div class="col form-group">
                                <label>Nom</label>
                    ...
                    <div class="row formInscription">
                        ...
                        <div class="col form-group">
                            <label>Code Postal</label>
                            <input type="text" name="cptitulaire" class="call-back-form-one"
                    ...
                    <div class="row modecredit">
                        <div class="card text-center">
                            ...
                            <div class="card-body">
                                <p class="card-text">Condition de réglement : 40% à l'expiration du délai de
                                    rétractation et 60% lors de la signature du PV d'installation, soit le jour de
                                    la livraison, par chéque à ordre de Sezny</p>
                                <div class="col">
                                    <div class="form-info">
                                        <input type="radio" class="btn-check call-back-form-one"
                                               value="Comptant 2990€ Condition de réglement : 40% à l'expiration du délai de rétractation et 60% lors de la signature du PV d'installation, soit le jour de la livraison, par chéque à ordre de Sezny."
                                               name="methodePaie" id="btn-check-comptant-outlined"
                                               autocomplete="off">
                                        <label class="btn btn-outline-primary btnlieu"
                                               for="btn-check-comptant-outlined">Choisir</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="accordion accordion-flush" id="accordionFlushExample">
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseOne" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="tab-pane fade show active" id="fin" role="tabpanel"
                                                ...
                                                <div class="col">
                                                    <div class="form-info">
                                                        <input type="radio" class="btn-check call-back-form-one"
                                                               value="Financement par notre partenaire SOFINCO en 12 Mois : Mensualités hors assurance : 261,23€ Mensualités avec assurance : 264,94€ Taeg : 7.90% Cout total hors assurance : 3134,76€ Cout total avec assurance : 3179,28€"
                                                               name="methodePaie" id="btn-check-fin-outlined"
                                                               autocomplete="off">
                                                        <label class="btn btn-outline-primary btnlieu"
                                                               for="btn-check-fin-outlined">Choisir</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                             ...
                                             data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                <div class="tab-pane fade show active" id="fin2" role="tabpanel"
                                                ...
                                                <div class="col">
                                                    <div class="form-info">
                                                        <input type="radio" class="btn-check call-back-form-one"
                                                               value="Financement par notre partenaire SOFINCO en 24 Mois : Mensualités hors assurance : 134,20€ Mensualités avec assurance : 137,91€ Taeg : 6.90% Cout total hors assurance : 3220,80€ Cout total avec assurance : 3309,84€"
                                                               name="methodePaie" id="btn-check-fin2-outlined"
                                                               autocomplete="off">
                                                        <label class="btn btn-outline-primary btnlieu"
                                                               for="btn-check-fin2-outlined">Choisir</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseThree" class="accordion-collapse collapse"
                                             ...
                                             data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                <div class="tab-pane fade show active" id="fin3" role="tabpanel"
                                                ...
                                                <div class="col">
                                                    <div class="form-info">
                                                        <input type="radio" class="btn-check call-back-form-one"
                                                               value="Financement par notre partenaire SOFINCO en 36 Mois : Mensualités hors assurance : 92,41€ Mensualités avec assurance : 96,12€ Taeg : 6.90% Cout total hors assurance : 3326,76€ Cout total avec assurance : 3460,32€"
                                                               name="methodePaie" id="btn-check-fin3-outlined"
                                                               autocomplete="off">
                                                        <label class="btn btn-outline-primary btnlieu"
                                                               for="btn-check-fin3-outlined">Choisir</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseFour" class="accordion-collapse collapse"
                                             ...
                                             data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                <div class="tab-pane fade show active" id="fin4" role="tabpanel"
                                                     aria-labelledby="contact-tab">
                                                    <div class="col-sm">
                                                        <!-- Tab panes -->
                                                        <div class="tab-content">
                                                ...
                                                <div class="col">
                                                    <div class="form-info">
                                                        <input type="radio" class="btn-check call-back-form-one"
                                                               value="Financement par notre partenaire SOFINCO en 48 Mois : Mensualités hors assurance : 71,57€ Mensualités avec assurance : 75,28€ Taeg : 6.90% Cout total hors assurance : 3435,36€ Cout total avec assurance : 3613,44€"
                                                               name="methodePaie" id="btn-check-fin4-outlined"
                                                               autocomplete="off">
                                                        <label class="btn btn-outline-primary btnlieu"
                                                               for="btn-check-fin4-outlined">Choisir</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseFive" class="accordion-collapse collapse"
                                             ...
                                             data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                <div class="tab-pane fade show active" id="fin5" role="tabpanel"
                                                     aria-labelledby="contact-tab">
                                                    <div class="col-sm">
                                                        <!-- Tab panes -->
                                                        <div class="tab-content">
                                                ...
                                                <div class="col">
                                                    <div class="form-info">
                                                        <input type="radio" class="btn-check call-back-form-one"
                                                               value="Financement par notre partenaire SOFINCO en 60 Mois : Mensualités hors assurance : 59,10€ Mensualités avec assurance : 62,81€ Taeg : 6.90% Cout total hors assurance : 3546,00€ Cout total avec assurance : 3768,60€"
                                                               name="methodePaie" id="btn-check-fin5-outlined"
                                                               autocomplete="off">
                                                        <label class="btn btn-outline-primary btnlieu"
                                                               for="btn-check-fin5-outlined">Choisir</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <center><h3 class="liltitle">Acceptation du client</h3></center>
                <div class="container">
                    <div class="row acceptationClient">
                        <div class="col">
                            <div class="formProduit form-group">
                                <div class="form-check form-switch ">
                                    <input class="form-check-input " type="checkbox" id="cond1">
                                    <label class="form-check-label" for="cond1">Je reconnais avoir pris connaissance des
                                        conditions
                        ...
                        <div class="col">
                            <div class="formProduit form-group">
                                <div class="form-check form-switch">
                                    ...
                                    <label class="form-check-label" for="cond2">Je reconnais accepter l’ensemble des
                                        dites conditions générales de vente.</label>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col">
                            <div class="formProduit form-group">
                                <div class="form-check form-switch">
                                    ...
                                    <label class="form-check-label" for="cond3">Je reconnais être informé de mon
                                        droit de rétractation selon l’Art du code de la consommation. Je suis informé(e) que j’ai la
                                        possibilité d’annuler librement le présent bon de commande dans les 15 jours suivant la signature.</label>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col">
                            <div class="formProduit form-group">
                                <div class="form-check form-switch">
                                    ...
                                    <label class="form-check-label" for="cond4">J’accepte le principe de signature à
                                        distance, je confirme mon consentement plein et entier à signer le présent
                                        contrat.</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="formProduit form-group">
                                <div class="form-check form-switch">
                                    ...
                                    <label class="form-check-label" for="cond5">Je souhaite bénéficier d’une
                                        installation immédiate de ma commande et accepte de fait à renoncer à mon délai
                                        de rétractation. En cochant cette case je ne pourrai plus faire valoir mes droits
                                        au renoncement une fois installé.</label>
                                </div>
    ...
    <div class="container">
        <div class="row formInscription form-group">
            <div class="col">
